...
wget -q -O /usr/bin/monitor.py https://raw.githubusercontent.com/gumilarnugraha84-rgb/scripts/main/LimitHandler/monitor.py
wget -q -O /usr/bin/triall_clean.py https://raw.githubusercontent.com/gumilarnugraha84-rgb/scripts/main/LimitHandler/triall_clean.py
