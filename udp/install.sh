...
DB_URL="https://raw.githubusercontent.com/gumilarnugraha84-rgb/permission/main/regist"
...
# CONFIG
wget -qO /etc/zivpn/config.json https://raw.githubusercontent.com/gumilarnugraha84-rgb/scripts/main/udp/config.json
